...
class PatroliFormConfig(models.Model):
    _name = 'petadigi.patroli.form_config'
    _description = 'Konfigurasi Form Publik Patroli'
    _rec_name = 'name'
    ...
    def _compute_public_url(self):
        ...
        for rec in self:
            rec.public_url = f"{base_url}/patroli/{rec.public_token}" if rec.public_token else ''
