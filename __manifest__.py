...
""",
    ...
    'data': [
        ...
        'views/strong_public_form_template.xml',
        'views/strong_point_form_config_views.xml',
        'views/patroli_public_form_template.xml',
        'views/patroli_form_config_views.xml',
    ...
    'demo': [
        'demo/00_referensi.xml',
        'demo/01_wilayah.xml',
        'demo/02_users.xml',
        'demo/03_operasional.xml',
    ],
    'installable': True,
    'application': True,
    'sequence': 1,
